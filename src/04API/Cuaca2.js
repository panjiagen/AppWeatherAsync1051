  ...
  async getWeather() {
    ...
    try {
        ...
        let response = await fetch(
            'http://api.openweathermap.org/data/2.5/weather?q=' + this.state.city + '&appid=35ddeaf92d6dab24768687518775b343&units=metric'
        );
  ...
  render() {
    ...
    <View style={styles.box2}>
      ...
      <View style={styles.Footerbar}>
            <Text style={styles.footerText}> agengpanji@2019 </Text>
        </View>
</View>
    );
  }
